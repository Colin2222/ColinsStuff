...
import com.Robothead4.colinsstuff.util.helpers.NBTHelper;
...
public class ColinQuarryTileEntity extends TileEntity implements ITickableTileEntity{
    public int x,y,z,tick;
    boolean initialized = false;

    public ColinQuarryTileEntity(final TileEntityType<?> tileEntityTypeIn){
    ...
    // y = what level the quarry digs to
    // tick = how often the quarry mines
    @Override
    public void tick() {
        if(!initialized)
        {
    ...
    // x and z are the width and height of each horizontal area mined each execution
    ...
    private boolean destroyBlock(BlockPos pos, boolean dropBlock, @Nullable Entity entity)
    {
        ...
        else
        {
            ...
            //2001 plays sound of block being broken
