...
public class NBTHelper {
    public static CompoundNBT toNBT(Object o)
    {
        ...
        if(o instanceof ColinQuarryTileEntity)
        {
            return writeColinQuarry((ColinQuarryTileEntity)o);
        }
        return null;
    }
    private static CompoundNBT writeColinQuarry(ColinQuarryTileEntity o)
    {
